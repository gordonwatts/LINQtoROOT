...
{
    /// <summary>
    /// Helps with executors that want to do local builds of one sort or another.
    /// </summary>
    public class LocalBuildBase
    {
        /// <summary>
        ...
        /// </summary>
        protected static DirectoryInfo TempDirectory = null;
        ...
        /// </summary>
        /// <returns></returns>
        private static DirectoryInfo CommonSourceDirectory()
        {
        ...
        /// </summary>
        protected void PreExecutionInit(string[][] classesToDictify)
        {
            if (_preExeInitDone)
                return;
        ...
        /// </summary>
        protected void AssembleAndLoadExtraObjects(FileInfo[] extraComponentFiles)
        {
            ///
        ...
        protected void CompileAndLoad(FileInfo templateRunner)
        {
        ...
        protected Dictionary<string, ROOTNET.Interface.NTObject> RunNtupleQuery(string tSelectorClassName, IEnumerable<KeyValuePair<string, object>> variablesToLoad,
