...
namespace TTreeDataModel
{
    ...
    public class ROOTClassShell
    {
        ...
        /// <summary>
        /// If this class represents a class that is burried in a TTree, this is true.
        /// In that case there is no proxy file, etc., that needs to represent this guy.
        /// </summary>
        public bool IsTTreeSubClass { get; set; }
