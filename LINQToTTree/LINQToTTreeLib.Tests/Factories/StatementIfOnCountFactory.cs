...
namespace LINQToTTreeLib.Statements
{
    ...
    public static partial class StatementIfOnCountFactory
    {
        ...
        public static StatementIfOnCount Create(IValue valueLeft_iValue, IValue valueRight_iValue1, StatementIfOnCount.ComparisonOperator comp_i, IStatement[] statements, IVariable[] vars)
        {
