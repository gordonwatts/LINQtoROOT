...
namespace TTreeParser
{
    ...
    public class ParseTTree
    {
        ...
        private IEnumerable<ROOTClassShell> ExtractROOTPlainClass(ROOTClassShell container, ROOTNET.Interface.NTBranch branch)
        {
            ...
            {
                throw new NotImplementedException("The class '" + branch.GetClassName() + "' is known as a class to ROOT, but nothign is specified - this looks like a shim generated by the I/O system rather than a real class - which it needs to be for ntuple conversion. This leaf will be ignored. Please make sure the correct libraries are loaded if you want to access it!");
            }
            if (cls.Name == "string")
            {
